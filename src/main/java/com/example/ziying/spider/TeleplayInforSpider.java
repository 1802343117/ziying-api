...
public class TeleplayInforSpider {

    private  static  final Integer SUCCESS = 200;

    // url 为 目标地址
    public static <elements> List<TeleplayInfor> getTeleplayList(String url){
        List<TeleplayInfor> books = new ArrayList<>();
...
//            System.out.println(elements);
            ...
            for (int i  = 0; i < elements.size(); i++) {
                TeleplayInfor teleplayInfor = new TeleplayInfor();
...
//                                    System.out.println(release);
                                    teleplayInfor.setTeleplayRelease(release);
                                }
                                if ( z == e.size()-2 ) {
                                    String place = eleRpl.text();
                                    System.out.print("地区：");
//                                    System.out.println(place);
                                    teleplayInfor.setTeleplayPlace(place);
                                }
...
//                            System.out.println(category);
                            teleplayInfor.setTeleplayCategory(category);
                            break;
                        case 1:
                            String leading = elementRpl.select("a").text();
                            System.out.print("主演：");
//                            System.out.println(leading);
                            teleplayInfor.setTeleplayLeading(leading);
                            break;
                        case 2:
                            String director = elementRpl.select("a").text();
                            System.out.print("导演：");
//                            System.out.println(director);
                            teleplayInfor.setTeleplayDirector(director);
                            break;
                    }
                }
...
//                System.out.println(arr[1]);
                teleplayInfor.setTeleplayIntro(arr[1]);
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");

                teleplayInfor.setLinkId(0);
                teleplayInfor.setCommentId(0);
                teleplayInfor.setTeleplayCover("http://www.zhoumody.com" + strImg);
                teleplayInfor.setTeleplayName(strTitle);
                teleplayInfor.setTeleplayScore(Float.parseFloat(strScore));
                books.add(teleplayInfor);
            }
    ...
    public static void main(String[] args) {
        String url = "http://www.zhoumody.com/type2/-----gold.html";
        System.out.println(getTeleplayList(url));
    }
}
